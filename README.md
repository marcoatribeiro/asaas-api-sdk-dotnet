...
```bash
dotnet add package TorinoInfo.AsaasSdk --version 1.0.2
```

### Using Package Manager Console

```powershell
Install-Package TorinoInfo.AsaasSdk -Version 1.0.2
```
...
```xml
<PackageReference Include="TorinoInfo.AsaasSdk" Version="1.0.2" />
```
