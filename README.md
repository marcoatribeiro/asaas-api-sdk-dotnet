...
```bash
dotnet add package TorinoInfo.AsaasSdk --version 1.0.9
```

### Using Package Manager Console

```powershell
Install-Package TorinoInfo.AsaasSdk -Version 1.0.9
```
...
```xml
<PackageReference Include="TorinoInfo.AsaasSdk" Version="1.0.9" />
```
