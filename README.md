...
```bash
dotnet add package TorinoInfo.AsaasSdk --version 1.0.1
```

### Using Package Manager Console

```powershell
Install-Package TorinoInfo.AsaasSdk -Version 1.0.1
```
...
```xml
<PackageReference Include="TorinoInfo.AsaasSdk" Version="1.0.1" />
```
